...
import AboutUsBg from "../../assets/images/koding.jpeg";
import { SectionTitle } from "../SectionTitles";
import AboutImg from "../../assets/images/resources/dikaFormal.jpg";
    ...
    <section className="aboutUsWrap py-[4.5rem] md:py-[5.5rem] lg:py-[6.5rem] xl:py-[7.5rem] relative w-full">
      ...
      <div className="container sm:container md:container lg:container xl:container 2xl:container mx-auto">
        <SectionTitle
          title="About"
          titleInner="Me"
          desc="I thrive in both solo and collaborative environments, seamlessly adapting my approach to suit the task at hand. Whether working independently or as part of a team, I'm always committed to achieving common goals and bringing innovative ideas to life."
        ></SectionTitle>
          ...
          <div className="grid gap-[1.875rem] lg:grid-cols-2 grid-cols-1">
            <div>
              <div className="aboutImg relative mt-[-5.625rem] ml-0 lg:ml-[-1.875rem]">
                <img
                  className="rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] relative z-[1] w-full shadow"
                  src={AboutImg}
                  alt=""
                ></img>
                {/* About Image */}
